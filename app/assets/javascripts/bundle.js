...
/***/ function(module, exports, __webpack_require__) {
	...
	var _count = __webpack_require__(189);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_count2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Count = function (_Component) {
	    ...
	    function Count(props) {
	        ...
	        _this.onIncrementHandler = _this.onIncrementHandler.bind(_this);
	        _this.onDecrementHandler = _this.onDecrementHandler.bind(_this);
	        return _this;
	    }

	    _createClass(Count, [{
	        key: 'onIncrementHandler',
	        value: function onIncrementHandler(event) {
	            this.props.incrementCount();
	        }
	    }, {
	        key: 'onDecrementHandler',
	        value: function onDecrementHandler(event) {
	...
	function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({ incrementCount: _index.incrementCount, decrementCount: _index.decrementCount }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Count);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_count = __webpack_require__(192);

	var _reducer_count2 = _interopRequireDefault(_reducer_count);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  count: _reducer_count2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _index.INCREMENT_COUNT:
	            return state + 1;
	        case _index.DECREMENT_COUNT:
	            return state - 1;
	    }
	    return state;
	};
